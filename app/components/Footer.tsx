      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-xs mb-4 text-secondary/70 italic">
              A Thyme to Heal offers wellness education and holistic support services. We do not diagnose, treat, cure, or prevent any disease, and our services are not a substitute for medical or mental health care.
            </p>
