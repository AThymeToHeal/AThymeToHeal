...
const tables: TableDefinition[] = [
  ...
  // Table 3: Clients (Client Information)
  {
    ...
    fields: [
      ...
      { name: 'DateCreated', type: 'dateTime', options: { dateFormat: { name: 'us' }, timeFormat: { name: '12hour' }, timeZone: 'America/New_York' } },
      // BookedRecord will be added after Booked table is created
    ],
  },
  ...
  // Table 7: FAQ Clicks
  {
    ...
    fields: [
      ...
      // FAQRecord will be added after FAQs table is created
    ],
  },
];

async function createTable(table: TableDefinition): Promise<string | null> {
  try {
...
async function addLinkedRecordField(
  tableId: string,
  fieldName: string,
